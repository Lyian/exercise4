...
public class ArtistRepository {
    ...
    public List<Artist> getArtistByRowid(String rowid) throws Exception{
        return jdbcTemplate.query("Select P.ROWID as Premiumnutzerid, N.ROWID as Nutzerid,  Name, N.Email, N.Benutzername, N.Passwort, P.Datum from Kuenstler join Premiumnutzer P on P.Email = Kuenstler.Email JOIN Nutzer N on N.Email = P.Email WHERE Kuenstler.ROWID = ?", new ArtistMapper(), rowid );
    }
